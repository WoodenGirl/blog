...
CREATE TABLE `article`  (
  ...
  `article_status` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '发布状态：0表示草稿，1表示已发布',
...
CREATE TABLE `category`  (
  ...
  `isInterrupt` tinyint NOT NULL DEFAULT 0 COMMENT '0',
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, 'Aprisxlz', 0, 0);
INSERT INTO `category` VALUES (2, 'acg', 0, 0);
INSERT INTO `category` VALUES (3, 'interest', 0, 0);
INSERT INTO `category` VALUES (4, 'technique', 0, 0);
INSERT INTO `category` VALUES (5, 'life', 0, 0);
INSERT INTO `category` VALUES (50, '小说', 2, 0);
INSERT INTO `category` VALUES (51, '漫画', 2, 0);
INSERT INTO `category` VALUES (52, '动漫', 2, 0);
INSERT INTO `category` VALUES (53, '电视剧', 2, 0);
INSERT INTO `category` VALUES (54, '电影', 2, 0);
INSERT INTO `category` VALUES (55, '综艺', 2, 0);
INSERT INTO `category` VALUES (56, '游戏', 2, 0);
INSERT INTO `category` VALUES (57, '音乐', 3, 0);
INSERT INTO `category` VALUES (58, '棋类', 3, 0);
INSERT INTO `category` VALUES (59, '书法', 3, 0);
INSERT INTO `category` VALUES (60, '绘画', 3, 0);
INSERT INTO `category` VALUES (61, '运动', 3, 0);
INSERT INTO `category` VALUES (62, '养动物', 3, 0);
INSERT INTO `category` VALUES (63, '计算机', 4, 0);
INSERT INTO `category` VALUES (64, '动画', 4, 0);
INSERT INTO `category` VALUES (65, '考大学', 5, 0);
INSERT INTO `category` VALUES (66, '大学', 5, 0);
INSERT INTO `category` VALUES (67, '找工作', 5, 0);
INSERT INTO `category` VALUES (68, '工作', 5, 0);
INSERT INTO `category` VALUES (69, '遇见', 5, 0);
INSERT INTO `category` VALUES (70, '生病', 5, 0);
INSERT INTO `category` VALUES (71, '生活', 5, 0);
...
CREATE TABLE `comment`  (
  ...
  `link_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `create_time` datetime NOT NULL COMMENT '创建时间',
...
CREATE TABLE `user`  (
  ...
  `role` tinyint NOT NULL DEFAULT 1 COMMENT '用户权限0管理员，1普通用户',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '用户状态0冻结，1正常',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('123', '哈哈哈哈', '12', '', NULL, NULL, 1, 0);
INSERT INTO `user` VALUES ('user_1111111111111111', 'Aprilsxz', '333', '', NULL, NULL, 0, 0);
